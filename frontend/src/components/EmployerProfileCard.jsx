    ...
    return (
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            {/* <Link
                    ...
                    className="block mt-4 bg-yellow-500 text-white text-center py-3 rounded-lg hover:bg-yellow-600"
                >
                    Company Details
                </Link>
                ...
                <Link
                    to="/analytics"
                                // className="flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-4 rounded-lg font-semibold transition"
                className="block mt-4 bg-indigo-600 text-white text-center py-3 rounded-lg hover:bg-indigo-700">
                    View Analytics
                </Link> */}
