      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 py-12 px-5">
        <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden">
          ...
          <div className="bg-blue-600 p-8 text-white">
            ...
            <h1 className="text-4xl font-extrabold mt-4">{job.title}</h1>

            <p className="text-blue-100 text-lg mt-2">{job.company}</p>
          </div>
          ...
          <div className="p-8 space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="bg-gray-100 p-5 rounded-2xl">
                <h3 className="text-gray-500 text-sm mb-1">Salary</h3>
