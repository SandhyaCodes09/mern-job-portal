...
//         <div className="w-full px-4 sm:px-6 lg:px-8 h-20 flex justify-between items-center">
//           {/* Logo */}
...
//             <Link to="/" className="font-medium hover:text-blue-700 transition">
//               Home
//             </Link>
//             <Link to="/jobs" className="font-medium hover:text-blue-700 transition">
//               Jobs
//             </Link>
//             <Link to="/companies" className="font-medium hover:text-blue-700 transition">
//               Companies
//             </Link>
//             <Link to="/about" className="font-medium hover:text-blue-700 transition">
//               About
//             </Link>
//           </nav>
...
//               <Bell size={22} className="text-gray-600 hover:text-blue-700" />
//               <span className="absolute top-1 right-1 w-4 h-4 rounded-full bg-red-500 text-white text-[10px] font-bold flex justify-center items-center">
//                 3
//               </span>
//             </button>
...
//               >
//                 <img
//                   src={`https://ui-avatars.com/api/?name=${user.first_name}+${user.last_name}&background=2563eb&color=fff`}
//                   alt="profile"
...
//               {/* Minimal Profile Dropdown */}
//               {profileOpen && (
//                 <div className="absolute right-0 mt-3 w-48 bg-white rounded-xl shadow-xl border overflow-hidden z-50">
//                   <Link
//                     to="/user/profile"
//                     onClick={() => setProfileOpen(false)}
//                     className="flex items-center gap-3 px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-100 transition"
//                   >
//                     <UserCheck size={18} />
//                     My Profile
//                   </Link>
...
//                     onClick={() => {
//                       setProfileOpen(false);
//                       // Add logout handler logic here
//                     }}
//                     className="w-full flex items-center gap-3 text-left px-4 py-3 text-sm font-medium hover:bg-red-50 text-red-600 transition"
//                   >
//                     <LogOut size={18} />
//                     Logout
//                   </button>
...
//       {/* Main Content Body */}
//       <main className="w-full flex-grow px-4 sm:px-6 lg:px-8 py-8 space-y-10">
//         {/* ==========================================
//             HERO SECTION
//         ========================================== */}
//         <section className="w-full">
//           <div className="bg-gradient-to-r from-blue-700 to-blue-500 rounded-3xl p-8 sm:p-10 text-white shadow-xl">
//             <h1 className="text-3xl sm:text-5xl font-bold">
//               Welcome Back, {user.first_name} 👋
//             </h1>
//             <p className="mt-4 text-base sm:text-lg text-blue-100">
//               Find your dream job, track your applications, and manage your
//               profile effortlessly.
//             </p>
//             <div className="mt-8 flex flex-wrap gap-4">
//               <Link
//                 to="/jobs"
//                 className="bg-white text-blue-700 px-6 py-3.5 rounded-xl font-semibold hover:bg-blue-50 transition"
//               >
//                 Browse Jobs
//               </Link>
//               <Link
//                 to="/user/profile"
//                 className="border border-white px-6 py-3.5 rounded-xl font-semibold hover:bg-white hover:text-blue-700 transition"
//               >
//                 View Profile
//               </Link>
//             </div>
...
//             <div className="bg-white rounded-2xl shadow-md p-6 border-l-4 border-blue-600 hover:shadow-lg transition">
//               <div className="flex justify-between items-center">
//                 <div>
//                   <p className="text-gray-500 text-sm">Applied Jobs</p>
//                   <h2 className="text-3xl font-bold text-blue-700 mt-2">12</h2>
//                 </div>
//                 <Briefcase size={38} className="text-blue-600" />
//               </div>
//             </div>

//             <div className="bg-white rounded-2xl shadow-md p-6 border-l-4 border-red-500 hover:shadow-lg transition">
//               <div className="flex justify-between items-center">
//                 <div>
...
//             <div className="bg-white rounded-2xl shadow-md p-6 border-l-4 border-yellow-500 hover:shadow-lg transition">
//               <div className="flex justify-between items-center">
//                 <div>
//                   <p className="text-gray-500 text-sm">Notifications</p>
//                   <h2 className="text-3xl font-bold text-yellow-500 mt-2">5</h2>
//                 </div>
//                 <Bell size={38} className="text-yellow-500" />
//               </div>
//             </div>
//           </div>
//         </section>
...
//                     <th className="py-3 font-semibold">Applied On</th>
//                   </tr>
//                 </thead>
//                 <tbody className="divide-y text-sm">
//                   <tr className="hover:bg-gray-50 transition">
//                     <td className="py-4 font-medium">Google</td>
//                     <td className="py-4">MERN Stack Developer</td>
...
//                       </span>
//                     </td>
//                     <td className="py-4 text-gray-500">15 Jul 2026</td>
//                   </tr>

//                   <tr className="hover:bg-gray-50 transition">
//                     <td className="py-4 font-medium">Microsoft</td>
//                     <td className="py-4">React Developer</td>
//                     <td className="py-4">Hyderabad</td>
//                     <td className="py-4">
//                       <span className="bg-green-100 text-green-700 px-3 py-1 rounded-full text-xs font-semibold">
//                         Shortlisted
//                       </span>
//                     </td>
//                     <td className="py-4 text-gray-500">10 Jul 2026</td>
//                   </tr>

//                   <tr className="hover:bg-gray-50 transition">
//                     <td className="py-4 font-medium">Amazon</td>
//                     <td className="py-4">Frontend Developer</td>
//                     <td className="py-4">Noida</td>
//                     <td className="py-4">
//                       <span className="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-xs font-semibold">
//                         Interview
//                       </span>
//                     </td>
//                     <td className="py-4 text-gray-500">08 Jul 2026</td>
//                   </tr>
//                 </tbody>
//               </table>
//             </div>
...
//           <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
//             <div className="bg-white rounded-3xl shadow-md p-6 hover:shadow-lg transition flex flex-col justify-between">
//               <div>
//                 <div className="flex justify-between items-start">
//                   <div>
//                     <h3 className="text-xl font-bold">MERN Developer</h3>
//                     <p className="text-gray-500 text-sm mt-1">Google</p>
//                   </div>
...
//               <Link
//                 to="/jobs"
//                 className="mt-6 block bg-blue-700 text-white text-center py-2.5 rounded-xl font-medium hover:bg-blue-800 transition"
//               >
//                 Apply Now
//               </Link>
//             </div>
...
//                 <div className="flex justify-between items-start">
//                   <div>
//                     <h3 className="text-xl font-bold">Node.js Developer</h3>
//                     <p className="text-gray-500 text-sm mt-1">Infosys</p>
//                   </div>
//                   <Heart className="text-red-500 cursor-pointer" size={20} />
//                 </div>
...
//                     </h3>
//                     <p className="text-gray-400 text-xs mt-0.5">Yesterday</p>
//                   </div>
//                 </div>
...
//                   <div>
//                     <h3 className="font-semibold text-sm">Profile Updated</h3>
//                     <p className="text-gray-400 text-xs mt-0.5">3 Days Ago</p>
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//             {/* Career Tips */}
//             <div className="bg-white rounded-3xl shadow-md p-6 sm:p-8">
//               <h2 className="text-xl font-bold mb-6">Career Tips</h2>
//               <div className="space-y-4">
...
//                     Recruiters are more likely to contact candidates with a
...
//         <div className="w-full px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row justify-between items-center gap-4">
//           <div>
//             <h2 className="text-xl font-bold text-blue-700">Job Portal</h2>
//             <p className="text-xs text-gray-500">
...
//               Home
//             </Link>
//             <Link to="/jobs" className="hover:text-blue-700 transition">
//               Jobs
//             </Link>
//             <Link to="/user/profile" className="hover:text-blue-700 transition">
//               Profile
//             </Link>
//           </div>
//         </div>
